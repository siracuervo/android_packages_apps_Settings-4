...
public class StatusBarNotifSystemIcons extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_COLORIZE_NOTIF_ICONS =
            "notif_system_colorize_notif_icons";
    private static final String PREF_NOTIF_COUNT =
            "status_bar_notif_count";
    private static final String PREF_NOTIF_SYSTEM_ICON_COLOR =
            "notif_system_icon_color";
    private static final String PREF_NOTIF_TEXT_COLOR =
            "notif_system_notif_text_color";
    private static final String PREF_NOTIF_COUNT_ICON_COLOR =
            "notif_system_notif_count_icon_color";
    private static final String PREF_NOTIF_COUNT_TEXT_COLOR =
            "notif_system_notif_count_text_color";

    private static final int DEFAULT_ICON_TEXT_COLOR = 0xffffffff;
    private static final int DEFAULT_COUNT_TEXT_COLOR = 0xff000000;
    ...
    public void refreshSettings() {
        ...
        if (Utils.isPhone(getActivity())) {
            mColorizeNotifIcons.setTitle(R.string.notif_system_colorize_notif_icons_title_phone);
        }
        mColorizeNotifIcons.setOnPreferenceChangeListener(this);

        mCount =
                (CheckBoxPreference) findPreference(PREF_NOTIF_COUNT);
        mCount.setChecked(showNotifCount);
        mCount.setOnPreferenceChangeListener(this);

        PreferenceCategory catColors =
                (PreferenceCategory) findPreference(PREF_CAT_COLORS);
        mIconColor =
                (ColorPickerPreference) findPreference(PREF_NOTIF_SYSTEM_ICON_COLOR);
        ...
        mCountColor =
                (ColorPickerPreference) findPreference(PREF_NOTIF_COUNT_ICON_COLOR);
        mCountTextColor =
                (ColorPickerPreference) findPreference(PREF_NOTIF_COUNT_TEXT_COLOR);
        if (showNotifCount) {
            intColor = Settings.System.getInt(mResolver,
