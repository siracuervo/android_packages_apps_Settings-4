...
public class StatusBarBatteryBar extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.status_bar_battery_bar);
        mResolver = getActivity().getContentResolver();

        boolean isBatteryBarEnabled = Settings.System.getInt(mResolver,
                Settings.System.STATUS_BAR_BATTERY_BAR_POSITION, 0) != 0;
        ...
        if (isBatteryBarEnabled) {
            ...
            int color = Settings.System.getInt(mResolver,
                    Settings.System.STATUS_BAR_BATTERY_BAR_COLOR, DEFAULT_COLOR);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        StatusBarBatteryBar getOwner() {
            return (StatusBarBatteryBar) getTargetFragment();
        }
