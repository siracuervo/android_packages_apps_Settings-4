...
public class StatusBarExpandedHeader extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        mHeaderSettingsButton.setChecked(Settings.System.getInt(mResolver,
                Settings.System.STATUS_BAR_EXPANDED_HEADER_SETTINGS_BUTTON, 0) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mHeaderSettingsButton) {
            ...
            intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(mResolver,
                Settings.System.STATUS_BAR_EXPANDED_HEADER_CLOCK_DATE_COLOR, intHex);
            preference.setSummary(hex);
            return true;
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setPositiveButton(R.string.dlg_reset_darkkat,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                Settings.System.STATUS_BAR_EXPANDED_HEADER_SETTINGS_BUTTON, 1);
                            Settings.System.putInt(getOwner().mResolver,
                                Settings.System.STATUS_BAR_EXPANDED_HEADER_BACKGROUND_COLOR,
                                DEFAULT_BACKGROUND_COLOR);
                            Settings.System.putInt(getOwner().mResolver,
