...
public class WeatherPrefs {
    ...
    public static final String KEY_USE_CELCIUS = "weather_use_celcius";
    public static final String KEY_REFRESH = "weather_refresh_interval";
    public static final String KEY_USE_CUSTOM_LOCATION = "weather_use_custom_location";
    public static final String KEY_CUSTOM_LOCATION = "weather_custom_location";
