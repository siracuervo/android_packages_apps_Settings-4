...
package com.android.settings.darkkat.weather;
...
public class WeatherInfo {
    ...
    public static String getTranslatedDirectionString(Context mContext, String degrees) {
        ...
        if (deg >= 338 || deg <= 22)
            return mContext.getResources().getString(R.string.weather_direction_north);
        else if (deg < 68)
            return mContext.getResources().getString(R.string.weather_direction_north_east);
        else if (deg < 113)
            return mContext.getResources().getString(R.string.weather_direction_east);
        else if (deg < 158)
            return mContext.getResources().getString(R.string.weather_direction_south_east);
        else if (deg < 203)
            return mContext.getResources().getString(R.string.weather_direction_east);
        else if (deg < 248)
            return mContext.getResources().getString(R.string.weather_direction_south_west);
        else if (deg < 293)
            return mContext.getResources().getString(R.string.weather_direction_west);
        else if (deg < 338)
            return mContext.getResources().getString(R.string.weather_direction_north_west);
        else
            return "";
    }
