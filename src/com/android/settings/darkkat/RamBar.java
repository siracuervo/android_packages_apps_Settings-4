...
public class RamBar extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String RAM_BAR_COLOR_FREE_MEM = "ram_bar_color_free_mem";
    ...
    public void refreshSettings() {
        ...
        mRamBarFreeMemColor = (ColorPickerPreference) findPreference(RAM_BAR_COLOR_FREE_MEM);
        ...
        if (ramBarMode == 0) {
            ...
            intColor = Settings.System.getInt(mResolver,
                    Settings.System.RECENTS_RAM_BAR_FREE_RAM_COLOR, DEFAULT_FREE_MEM_COLOR);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.ram_bar_reset_default:
                ...
                refreshSettings();
                return true;
            case R.id.ram_bar_reset_darkkat_default:
                Settings.System.putInt(mResolver,
                    Settings.System.RECENTS_RAM_BAR_ACTIVE_APPS_COLOR, DEFAULT_ACTIVE_APPS_COLOR);
                Settings.System.putInt(mResolver,
                    Settings.System.RECENTS_RAM_BAR_CACHE_COLOR, 0xffaaaaaa);
                Settings.System.putInt(mResolver,
                    Settings.System.RECENTS_RAM_BAR_MEM_COLOR, 0xff666666);
                Settings.System.putInt(mResolver,
                    Settings.System.RECENTS_RAM_BAR_FREE_RAM_COLOR, 0xff00ff00);
                refreshSettings();
                return true;
            default:
