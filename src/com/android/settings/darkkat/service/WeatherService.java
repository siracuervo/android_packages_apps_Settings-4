...
import com.android.settings.darkkat.weather.WeatherInfo;
import com.android.settings.darkkat.weather.WeatherPrefs;
import com.android.settings.darkkat.weather.WeatherXmlParser;
...
public class WeatherService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (Settings.System.getInt(getContentResolver(), Settings.System.STATUS_BAR_EXPANDED_ENABLE_WEATHER, 0) == 0) {
            stopSelf();
            return;
        }
				...
				if (networkAvailable) {
                    ...
                    if (!intent.hasExtra(INTENT_EXTRA_NEWLOCATION)) {
                        ...
                        if (bestProvider != null) {
                            ...
                            if (manual) {
                                makeToast(context.getString(R.string.weather_location_unavailable));
                            }
                        }
                        return;
                    }
