...
public class InputMethodsSettings extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_DISABLE_FULLSCREEN_KEYBOARD =
        "disable_fullscreen_keyboard";
    private static final String KEY_IME_SWITCHER =
        "status_bar_ime_switcher";
    private static final String VOLUME_KEY_CURSOR_CONTROL =
        "volume_key_cursor_control";
    private static final String KEYBOARD_ROTATION_TOGGLE =
        "keyboard_rotation_toggle";
    private static final String KEYBOARD_ROTATION_TIMEOUT =
        "keyboard_rotation_timeout";
    private static final String SHOW_ENTER_KEY =
        "show_enter_key";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (DeviceUtils.isPhone(getActivity())) {
            ...
            removePreference(PREF_DISABLE_FULLSCREEN_KEYBOARD);
        }
