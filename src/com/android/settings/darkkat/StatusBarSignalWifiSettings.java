...
public class StatusBarSignalWifiSettings extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_NETWORK_FULLY_COLOR =
            "signal_wifi_network_icons_fully_color";
    private static final String PREF_ACTIVITY_NORMAL_COLOR =
            "signal_wifi_network_activity_icons_normal_color";
    private static final String PREF_ACTIVITY_FULLY_COLOR =
            "signal_wifi_network_activity_icons_fully_color";
    private static final String PREF_AIRPLANE_COLOR =
            "signal_wifi_airplane_mode_icon_color";
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        StatusBarSignalWifiSettings getOwner() {
            return (StatusBarSignalWifiSettings) getTargetFragment();
        }
