...
public class NotificationDrawer extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private static final String PREF_NotificationDrawer_COLLAPSE_BEHAVIOUR = "notification_drawer_collapse_on_dismiss";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCollapseOnDismiss = (ListPreference) findPreference(PREF_NotificationDrawer_COLLAPSE_BEHAVIOUR);
